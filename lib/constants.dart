...
const String categoriesCollectionPath =
    'artifacts/default-app-id/public/data/categories';
const String townshipsCollectionPath =
    'artifacts/default-app-id/public/data/townships';
const String announcementsCollectionPath =
    'artifacts/default-app-id/public/data/announcements';
...
const String settingsCollectionPath =
    'artifacts/default-app-id/public/data/settings';
